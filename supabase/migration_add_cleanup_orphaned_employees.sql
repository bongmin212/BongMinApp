-- Migration: Add function to cleanup orphaned employees
-- Run this in Supabase SQL editor

-- Function to find and delete orphaned employees (employees without auth users)
...
GRANT EXECUTE ON FUNCTION public.cleanup_orphaned_employees() TO anon;
